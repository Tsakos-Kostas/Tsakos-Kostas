$("document").ready(function () {
  ...
  function skipToEnd(message) {
    ...
    const error =
      currentLanguage === "greek"
        ? "Λυπούμαστε αλλά δεν δικαιούστε Πιστοποιητικό οικογενειακής κατάστασης!"
        : "We are sorry but you are not entitled to receive a Certificate of family status!";
  ...
  function submitForm() {
    ...
    currentLanguage === "greek"
      ? $(".question-container").append(
          "<br /><br /><h5 class='answer'>Τα βήματα που πρέπει να κάνετε για να λάβετε το Πιστοποιητικό οικογενειακής κατάστασης:</h5><br />"
        )
      : $(".question-container").append(
          "<br /><br /><h5 class='answer'>The steps that you need to do in order to receive your Certificate of family status are:</h5><br />"
        );
    ...
    if ($(".govgr-radios__input").is(":checked")) {
      ...
      console.log(selectedRadioButtonIndex);
       if (currentQuestion === 0 && selectedRadioButtonIndex === 2) {
        currentQuestion = -1;
        currentLanguage === "greek" ? skipToEnd("Πρέπει να είστε νόμιμος κάτοικος της Ελλάδας.") : skipToEnd("You must be a legal resident of Greece.");
      } else if (currentQuestion === 1 && selectedRadioButtonIndex === 2) {
        currentQuestion = -1;
        currentLanguage === "greek" ? skipToEnd("Πρέπει να έχετε κωδικούς Taxisnet για την εκδοσή Πιστοποιητικού οικογενειακής κατάστασης.") : skipToEnd("You must have Taxisnet codes in order to receive a Certificate of family status.");
      } else if (currentQuestion === 2 && selectedRadioButtonIndex === 2) {
        currentQuestion = -1;
        currentLanguage === "greek" ? skipToEnd("Πρέπει να παρέχετε συναίνεση στο σύστημα ώστε να μπορείτε να λάβετε το Πιστοποιητικό οικογενειακής κατάστασης.") : skipToEnd("You must provide consent to the system in order to receive the Certificate of family status.");
      }
       else {
